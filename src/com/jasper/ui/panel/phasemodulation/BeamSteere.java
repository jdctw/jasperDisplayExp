 ...
 */
package com.jasper.ui.panel.phasemodulation;
 ...
 * @author sonnv
 */
public class BeamSteere extends OpticsPane{
    ...
    static String logmessageMirror = "Beam Steerer : Phy=%s Theta=%s";
    private double phy = 1, theta = 1;
    private int countSecondDisplayMirror = 1;
    private int countLenOnMirror = 1;
       
    public BeamSteere(ResourceBundle labels, BindingGroup bindingGroup,JPanel panelPattern, JTabbedPane jTabbedControler) {
        this.labels = labels;
    ...
    private void initComponents(BindingGroup bindingGroup) {
        ...
        jPanelMirror = new javax.swing.JPanel();
        panelButtonMirror = new javax.swing.JPanel();
        javax.swing.GroupLayout panelButtonMirrorLayout = new javax.swing.GroupLayout(panelButtonMirror);
        panelButtonMirror.setLayout(panelButtonMirrorLayout);
        panelButtonMirrorLayout.setHorizontalGroup(
                ...
                .addGroup(panelButtonMirrorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(panelButtonMirrorLayout.createSequentialGroup()
                .addGap(0, 0, 0)
    ...
    public JPanel getJPanelMirror() {
        return jPanelMirror;
    }
    
    public JPanel getJPanelButtonMirror() {
