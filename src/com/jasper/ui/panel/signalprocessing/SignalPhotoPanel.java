...
public class SignalPhotoPanel extends OpticsPane{
    ...
    private void initComponents(BindingGroup bindingGroup) {
        ...
        lblFilePath.setText(Constant.FILE_PATH + File.separator + Constant.FILE_NAME_SIGNAL);
    ...
    public void setLog(String msg) {
        ...
        try {
            ...
            filePath = Constant.FILE_PATH + File.separator + Constant.FILE_NAME_SIGNAL;
            // Check file logs exists
            if(Utils.checkFileExists(Constant.FILE_PATH + File.separator + Constant.FILE_NAME_SIGNAL)) {
                Utils.writeFile(filePath, msg, false);
            } else {
                Utils.createDirectory(File.separator + Constant.FILE_NAME_SIGNAL);
                Utils.writeFile(filePath, msg, false);
            }
        } catch (Exception e) {
        }
