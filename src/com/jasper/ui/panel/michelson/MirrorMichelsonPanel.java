 ...
 * @author sonnv
 */
public class MirrorMichelsonPanel extends OpticsPane{
    ...
    public MirrorMichelsonPanel(ResourceBundle labels, BindingGroup bindingGroup,JPanel panelPattern) {
        this.labels = labels;
