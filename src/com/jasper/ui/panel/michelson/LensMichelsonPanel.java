 ...
 * @author sonnv
 */
public class LensMichelsonPanel extends OpticsPane{
    ...
    private javax.swing.JPanel panelMichelsonButton;
     ...
     public LensMichelsonPanel(ResourceBundle labels, BindingGroup bindingGroup, JPanel panelPattern) {
        this.labels = labels;
