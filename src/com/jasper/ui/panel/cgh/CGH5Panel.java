 ...
 * @author sonnv
 */
public class CGH5Panel extends OpticsPane{
    ...
    public CGH5Panel(ResourceBundle labels, BindingGroup bindingGroup,JPanel panelPattern) {
        this.labels = labels;
    ...
    private void initComponents(BindingGroup bindingGroup) {
        ...
        lblFilePath.setText(Constant.FILE_PATH + File.separator + Constant.FILE_NAME_CGH5);
        lblFilePath.setForeground(Color.blue);
        lblFilePath.setFont(new Font("Arial", Font.PLAIN , 10));
        
        panelButton = new javax.swing.JPanel();
        javax.swing.GroupLayout panelButtonCGH5Layout = new javax.swing.GroupLayout(panelButton);
        panelButton.setLayout(panelButtonCGH5Layout);
        ...
        getText = Utils.readFile(Constant.FILE_PATH + File.separator + Constant.FILE_NAME_CGH5);
        ...
        javax.swing.GroupLayout CGH5Layout = new javax.swing.GroupLayout(panel);
        panel.setLayout(CGH5Layout);
