 ...
 * @author sonnv
 */
public class CGH8Panel extends OpticsPane{
    ...
    public CGH8Panel(ResourceBundle labels, BindingGroup bindingGroup,JPanel panelPattern) {
        this.labels = labels;
    ...
    private void initComponents(BindingGroup bindingGroup) {
        ...
        lblFilePath.setText(Constant.FILE_PATH + File.separator + Constant.FILE_NAME_CGH8);
        ...
        getText = Utils.readFile(Constant.FILE_PATH + File.separator + Constant.FILE_NAME_CGH8);
