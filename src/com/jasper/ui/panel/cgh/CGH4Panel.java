 ...
 * @author sonnv
 */
public class CGH4Panel extends OpticsPane{
    ...
    public CGH4Panel(ResourceBundle labels, BindingGroup bindingGroup,JPanel panelPattern) {
        this.labels = labels;
    ...
    private void initComponents(BindingGroup bindingGroup) {
        ...
        lblFilePath.setText(Constant.FILE_PATH + File.separator + Constant.FILE_NAME_CGH4);
        lblFilePath.setForeground(Color.blue);
        lblFilePath.setFont(new Font("Arial", Font.PLAIN , 10));
        
        javax.swing.GroupLayout panelButtonCGH4Layout = new javax.swing.GroupLayout(panelButton);
        panelButton.setLayout(panelButtonCGH4Layout);
        ...
        getText = Utils.readFile(Constant.FILE_PATH + File.separator + Constant.FILE_NAME_CGH4);
        ...
        javax.swing.GroupLayout CGH4Layout = new javax.swing.GroupLayout(panel);
        panel.setLayout(CGH4Layout);
